...
# Load data
#gwas_raw <- read_tsv(
#    "/home/rrunyan1/Rose/results/nemascan/tropicalis/LOCO/Mapping/Raw/TELOMERE_RESID_lmm-exact.loco.mlma",
#  col_types = cols()
#) 


qtl_peaks <- read_tsv(
  "/home/rrunyan1/Rose/results/nemascan/run1/tropicalis/LOCO/Mapping/Processed/QTL_peaks_loco.tsv"
)
# isolate chr II QTL 
qtl_chrII <- qtl_peaks %>%
  filter(CHROM == "II") %>%
...
d.all <- fread("/home/rrunyan1/Rose/results/nemascan/run1/tropicalis/LOCO/Mapping/Processed/processed_LENGTH_ESTIMATE_AGGREGATE_mapping_loco.tsv") %>%
...
total_independent_tests <- read.table(
  "/home/rrunyan1/Rose/results/nemascan/run1/tropicalis/Genotype_Matrix/total_independent_tests.txt"
)
...
# Add gene labels
#genes <- data.frame(
#  CHROM = c("III", "II", "III", "II", "IV", "I"),
#  start = c(7131880, 14524173, 13780215, 14362019, 5541627, 8765745),
#  end   = c(7133678, 14525108, 13781133, 14365179, 5544748, 8771251),
#  gene  = c("pot-1", "pot-2","pot-3", "tebp-1", "tebp-2", "trt-1")
#)
...
ggplot2::ggsave(
  filename = "/home/rrunyan1/Rose/plots/tropicalis/trop_man_plot.png",
  plot = manhattan_plot,
  width = 4.5,      # in inches
